...
class CredentialsVC: UIViewController, UITextFieldDelegate {
    ...
    func attemptLogIn() {
        ...
        if volunteersTabIsSelected == true {
            storyboardName = STORYBOARD_NAME_VOL
        } else {
            storyboardName = STORYBOARD_NAME_ORG
        }
        
        let storyboard = UIStoryboard(name: storyboardName, bundle: nil)
        let vc = storyboard.instantiateViewControllerWithIdentifier(VC_IDENTIFIER) as UIViewController
